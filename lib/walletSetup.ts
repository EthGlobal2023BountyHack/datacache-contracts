...
export function initDataStorage(rpcUrl, contractAddress): IDataStorage {
...
export async function initInMemoryDataStorageAndWallets(rpcUrl, contractAddres) {
    const dataStorage = initDataStorage(rpcUrl, contractAddres);
